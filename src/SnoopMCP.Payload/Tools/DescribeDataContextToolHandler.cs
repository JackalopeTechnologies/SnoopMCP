// DescribeDataContextToolHandler.cs
...
/// <summary>
/// Wire handler for the <c>describeDataContext</c> tool. Resolves the element id and marshals
/// <see cref="DataContextInspector.DescribeDataContext"/> onto the WPF dispatcher.
/// </summary>
public sealed class DescribeDataContextToolHandler : IToolHandler
{
    /// <summary>The wire-protocol tool name.</summary>
    public const string DescribeDataContextToolName = "describeDataContext";
    ...
    /// <summary>
    /// Initialises a new <see cref="DescribeDataContextToolHandler"/>.
    /// </summary>
    ...
    /// <inheritdoc />
    public string ToolName => DescribeDataContextToolName;

    /// <inheritdoc />
    public Task<JsonElement> ExecuteAsync(JsonElement arguments, CancellationToken cancellationToken)
    {
        DescribeDataContextRequest request = arguments.Deserialize<DescribeDataContextRequest>(WireSerializer.JsonOptions)
